...
parrot = Parrot("SANDY DWI JULIAN", 12, "blue")
parrot.speak() # Output: SANDY DWI JULIAN is a blue parrot that talks
parrot.fly() # Output: SANDY DWI JULIAN is flying with a wingspan of